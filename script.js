...
const rectangleWidth = a4Width - marginLeft - marginRight;
const rectangleHeight = a4Height - marginTop - marginBottom;
const calliLineBuffer = 5;
const ratioAscender = 3;
const ratioBase = 2;
const ratioDescender = 3;
const addLinesBetween = true;
const xHeight = 5;
const newSVG = createSVG(a4Width, a4Height);
const area = drawRectangle(newSVG, marginLeft, marginTop, rectangleWidth, rectangleHeight, roundingRadius);
const width = rectangleWidth;
const height = rectangleHeight - calliLineBuffer * 2;
...
const gapBetweenElements = calculateGap(height, calliHeight, repetitions);
console.log("Number of repetitions:", repetitions);
console.log("Gap between elements:", gapBetweenElements);

let offset = marginTop + calliLineBuffer;
...
const myCalliGrid = new CalliGrid({
  document: {
    width: 210,
    height: 297,
    margins: {
